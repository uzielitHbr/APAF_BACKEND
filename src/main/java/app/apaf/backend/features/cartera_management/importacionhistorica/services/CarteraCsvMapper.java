...
public class CarteraCsvMapper {
    ...
    public CarteraDatos map(CarteraCsvRow row, YearMonth periodo, UUID idImportacion) {
        ...
        entity.setTasaOrdinariaNominalAnual(
                valueParser.parseBigDecimal(row.getColumn(10), "tasaOrdinariaNominalAnual", ln));
        entity.setTasaMoratoriaNominalAnual(
                valueParser.parseBigDecimal(row.getColumn(11), "tasaMoratoriaNominalAnual", ln));
        ...
        entity.setIntDevNoCobradosVigentes(
                valueParser.parseBigDecimal(row.getColumn(18), "intDevNoCobradosVigentes", ln));
        entity.setIntDevNoCobradosVencidos(
                valueParser.parseBigDecimal(row.getColumn(19), "intDevNoCobradosVencidos", ln));
        entity.setIntDevNoCobradosCtasOrden(
                valueParser.parseBigDecimal(row.getColumn(20), "intDevNoCobradosCtasOrden", ln));
        ...
        entity.setFechaUltimoPagoIntereses(
                valueParser.parseLocalDate(row.getColumn(23), "fechaUltimoPagoIntereses", ln));
        entity.setMontoUltimoPagoIntereses(
                valueParser.parseBigDecimal(row.getColumn(24), "montoUltimoPagoIntereses", ln));
        ...
        entity.setMontoGarantiaHipotecaria(
                valueParser.parseBigDecimal(row.getColumn(32), "montoGarantiaHipotecaria", ln));
        entity.setEprcContableParteCubierta(
                valueParser.parseBigDecimal(row.getColumn(33), "eprcContableParteCubierta", ln));
        entity.setEprcContableParteExpuesta(
                valueParser.parseBigDecimal(row.getColumn(34), "eprcContableParteExpuesta", ln));
        entity.setEprcContableXInteresesCee(
                valueParser.parseBigDecimal(row.getColumn(35), "eprcContableXInteresesCee", ln));
        entity.setImporteEstimacionAdicional(
                valueParser.parseBigDecimal(row.getColumn(36), "importeEstimacionAdicional", ln));
