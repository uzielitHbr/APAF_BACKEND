...
public class CsvValueParser {
    ...
    public LocalDate parseLocalDate(String value, String fieldName, int lineIndex) {
        ...
        try {
            ...
            throw new CampoCsvInvalidoException(
                    String.format("Error en línea %d, campo %s: valor '%s' no es una fecha válida (dd/MM/yyyy)",
                            lineIndex, fieldName, value));
        }
    }
    ...
    public BigDecimal parseBigDecimal(String value, String fieldName, int lineIndex) {
        ...
        try {
            ...
            throw new CampoCsvInvalidoException(String.format(
                    "Error en línea %d, campo %s: valor '%s' no es un decimal válido", lineIndex, fieldName, value));
        }
    }
    ...
    public Integer parseInteger(String value, String fieldName, int lineIndex) {
        ...
        try {
            ...
            throw new CampoCsvInvalidoException(String.format(
                    "Error en línea %d, campo %s: valor '%s' no es un entero válido", lineIndex, fieldName, value));
        }
    }
    ...
    public Short parseShort(String value, String fieldName, int lineIndex) {
        ...
        try {
            ...
            throw new CampoCsvInvalidoException(
                    String.format("Error en línea %d, campo %s: valor '%s' no es un número corto (short) válido",
                            lineIndex, fieldName, value));
        }
    }
    ...
    public Boolean parseBoolean(String value, String fieldName, int lineIndex) {
        ...
        throw new CampoCsvInvalidoException(
                String.format("Error en línea %d, campo %s: valor '%s' no es un booleano válido (0/1 o true/false)",
                        lineIndex, fieldName, value));
    }
    ...
    public String parseEmproblemado(String value, String fieldName, int lineIndex) {
        if (value == null || value.isBlank()) {
            throw new CampoCsvInvalidoException(
                    String.format("Error en línea %d, campo %s: el valor es obligatorio", lineIndex, fieldName));
        }
        String trimmed = value.trim();
        ...
        throw new CampoCsvInvalidoException(String.format(
                "Error en línea %d, campo %s: valor '%s' no es válido. Debe ser '0', '1' o 'Emproblemado'", lineIndex,
                fieldName, value));
    }
}
